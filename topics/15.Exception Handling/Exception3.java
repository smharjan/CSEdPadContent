...
public class ArrayException {
  public static void main(String[] args) {
    /*
     * logical_step_1: Initalize an array variable called num of type integer of size 4
     * question_1: what does the following code block do?
     * answer_1: Declare array variable called num of type integer of size 4
    ...
    /*
     * logical_step_2: Assign integer values 1,3, and 4 to indexes 0, 1, and 3.
     * question 1: what does the following code block do?
     * answer_1: Assign integer values of 1, 3, and 4 to indexes 0, 1, and 3 of array num.
    ...
    /*
     * logical_step_3: Within a try block, loops through array num, outputing the item at each index. 
     * question 1: what does the following code block do?
