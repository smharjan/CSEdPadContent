...
Public class Main {
 public static void main(String[] args) {
  ...
  /*
   logical_step1: Declare a try and catch statement to catch the exception occured during the execution of a program. Within the try block we create
   variable of string data type and find out the which character is at index position 0. 
  ...
  /*
  logical_step_1: Create a variable of string data type.
  logical_step_details: Declare a variable empty of string data type with null value assigned to it.
  question_1: What variable is declared?
  answer_1: Variable empty is declared.
  ...
  */
  ...
  /*
  logical_step_2: Find index position 0 of the character present in  the string variable empty.
  ...
  */
  ...
  answer_3: Catch Null pointer Exception thrown by the previous code of block in try block. 
  */
