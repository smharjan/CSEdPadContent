...
class WhileLoopsEx1 {
  public static void main(String[] args) {
    ...
    */
    while (i <= 1000) {
      /** @comment (loop condition that depends on variable i) */
      sum += i;
      i++; /**
            * @comment (loop variable i is being incremented which is important in order
            *          for the loop condition to change
            */
    }
