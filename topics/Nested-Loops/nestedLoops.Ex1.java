...
class NestedForLoop {
	...
	*/
	...
	/*
	logical_step 2: Scan all the squares on the chessboard, scanning an entire row at a time.
	...
	question_1: What does the following code block do?
	answer_1: Scan all the squares on the chessboard, scanning an entire row at a time.
	question_2: What does the outer loop do?
	answer_2: The outer loop uses an integer variable i to scan all values from 1 to 8.
	question_3: What does the inner or nested loop do?
	answer_3: The inner loop uses a second integer variable j that scans all the values from 1 to 8.	
	*/
	for (int i = 1; i <= 8; ++i) {
		System.out.println("Outer loop iteration " + i);
		
		/*stm_comment: This is the inner loop. */
        for (int j = 1; j <=8; ++j) {
