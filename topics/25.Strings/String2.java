...
***/
 ...
 class EgString {
   ...
   {
   		/*
		logical_step_1: Declare a  variable s1
		question_1: What is the value of the variable s1  ?
		answer_1: the value of the variable var is The University of Memphis
		...
		*/
		...
		type string and allocate memory for it*/

		String s2="Department of Computer Science"; 


		/*
		logical_step_1: Printing out the length of the string s1.
