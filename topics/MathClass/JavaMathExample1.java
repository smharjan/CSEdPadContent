/**
 ...
 goalDescription: Construct a program that finds the length of the hypotenuse in of a right triangle by using the Pythagoras theorem then finds the angles of that triangle.
...
public class MathExample1{
  ...
  public static void main (String[]args)
  {
    ...
    /*
       ...
       Then convert to convert into degrees by multiplying it by 180 and divide it by PI.
    ...
    /*stmt_comment: Print Angles are A =  the value of the A variable, B = the value of the B variable, C = 90 */
