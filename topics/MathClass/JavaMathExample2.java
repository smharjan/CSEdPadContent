/**
 ...
 goalDescription: Construct a program that finds the area and circumference of a circle.
 ...
 public static void main (String[]args)
  {
    ...
    /*
       logical_step_1: Declare a double variable called radius and assign 3 as a value.
       logical_step_details: Declare a double variable called radius and assign 3 as a value.
       question_1: What does the following code block do?
       answer_1: Declare a double variable called radius and assign 3 as a value.
       question_2: What the value of radius?
       answer_2: 3
     */
     /*stmt_comment: Declare and initialize the variable radius to 3 */
    double radius = 3;
     ...
     */
     /*stmt_comment: Declare and initialize the variable area to the value of Math.PI * (radius * radius) */
    double area = Math.PI * (radius * radius);
    /*stmt_comment: Declare and initialize the variable circumference to the value of Math.PI * 2 * radius */
